...
function preload() {
    ...
    game.load.spritesheet('bg_button_desert', 'assets/sprites/ui/bg_button_desert.png', 236, 270, 3);
    game.load.spritesheet('bg_button_forest', 'assets/sprites/ui/bg_button_forest.png', 236, 270, 3);
